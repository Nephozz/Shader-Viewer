...
int main() {
    ...
    Shader shader = shader_create("res/shader/shader.vert", "res/shader/star_pal.frag");
    Shader shader2 = shader_create("res/shader/shader.vert", "res/shader/star.frag");
    Shader shader3 = shader_create("res/shader/shader.vert", "res/shader/test.frag");
    Shader shader4 = shader_create("res/shader/shader.vert", "res/shader/shape.frag");
